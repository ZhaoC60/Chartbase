 ...
 * @LastEditTime: 2023-12-02 13:18:52
      ...
      <div class="content">
        ...
        <div class="con-r" v-show="actIndex == 3">
          <div v-for="(item, ind) in [project[proPage]]" :key="ind" style="font-size: 0.9rem; line-height: 1.5rem; justify-content: space-between">
            ...
            <div class="piclist">
              <div v-for="i in item.url" :key="i">
                <!-- <img src="../assets/img/cat1.jpg" alt="" srcset="" /> -->
                <el-image style="width: 3.5rem; height: auto" :src="i" :preview-src-list="[i]"> </el-image>
              </div>
            </div>
          </div>
      ...
      project: [
        {
          ...
          url: [require('../assets/img/cat1.jpg'), require('../assets/img/cat1.jpg'), require('../assets/img/cat1.jpg')],
        },
        {
  ...
  .menu {
    ...
    .content {
      ...
      .con-l {
        ...
        position: absolute;
        left: 0;
        background-color: #de358750;
        background-image: linear-gradient(to left, #d0b0fb50, #d0b0fb80);
        display: flex;
        align-items: center;
        flex-direction: column;
        border-radius: 0.3rem;
        border-right: 0.25rem dashed #bca0ee;
        .title-btn {
          margin: 1rem 0;
          font-size: 1.3rem;
          height: 4.5rem;
        ...
        .tab--active {
          transform: scale(1.2);
          color: #fffd67;
          border-bottom: 0.2rem dotted #fffd67;
        }
      }
      .con-r {
        position: absolute;
