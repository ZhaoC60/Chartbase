  ...
  <div class="right" :style="{width:videoStyle.videoBOXWidth}">
    <div class="right_bottom">
      <div
        ...
        :key="index"
        :style="{height:videoStyle.videoHeight,width:videoStyle.videoWidth}"
      >
    ...
    videoList: {
      ...
      default: () => {
        return [
          ...
          {
            videopath: "/video/fire05.mp4",
            title: "消防车002",
            timer: "20210204 00:00:00"
          },
          {
            videopath: "/video/fire03.mp4",
            title: "东门2号监控",
            timer: "20210204 00:00:00"
          },
          {
            videopath: "/video/fire02.mp4",
            title: "3号路口监控",
            timer: "20210204 00:00:00"
          },
          {
